...
function initializeApp(){
  ...
  var firstCard = createCard('club', 'ten');
  dynamicCol.append(firstCard); // or $(dynamicCol).append(firstCard);
  var firstRandomCard = createRandomCard();
  dynamicCol.append(firstRandomCard);
  addRandomCardToDom();
  var addCardButton = $('<button>', {text: 'Add Card to DOM',click: addRandomCardToDom});
